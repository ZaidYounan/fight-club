    ...
    <>
        <div className="image-aboutus-banner">
            <div className="col-lg-8 about-text">
                ...
                <h2>Fight Club is a database of local fighters. It is intended to help coaches in finding competitors of the appropriate weight class and experience to match with their fighters.</h2>
